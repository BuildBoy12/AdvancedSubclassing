...
namespace Subclass
{
    ...
    public sealed class Config : IConfig
    {
        ...
        {
            [RoleType.ChaosInsurgency] = 0f,
            [RoleType.ClassD] = 0f,
            [RoleType.FacilityGuard] = 0f,
            [RoleType.NtfCadet] = 0f,
            [RoleType.NtfCommander] = 0f,
            [RoleType.NtfLieutenant] = 0f,
            [RoleType.NtfScientist] = 0f,
            [RoleType.Scientist] = 0f,
            [RoleType.Scp049] = 0f,
            [RoleType.Scp0492] = 0f,
            [RoleType.Scp079] = 0f,
            [RoleType.Scp096] = 0f,
